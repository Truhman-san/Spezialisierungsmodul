...
from src.unet.losses import sparse_ce, focal_plus_dice
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--images_dir", type=str, default="data/ninth_training_fixseventh/images")
    p.add_argument("--masks_dir", type=str, default="data/ninth_training_fixseventh/masks")

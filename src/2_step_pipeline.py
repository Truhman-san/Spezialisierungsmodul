...
def predict_pipeline(image_tf):
    ...
    Returns:
        ...
        pred_labels:(H,W) uint8 (gegatede Defektlabels – Ensemble nur auf Hintergrund)
...
OUTPUT_DIR     = PROJECT_ROOT / "runs" / "pipeline_rows_plus_ensemble" / "predictions_real_tripanel"
